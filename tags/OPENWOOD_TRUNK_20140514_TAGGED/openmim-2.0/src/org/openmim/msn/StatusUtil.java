...
{
  public final static int NATIVE_STATUS_OFFLINE = 0;
  public final static int NATIVE_STATUS_ONLINE  = 1;
  public final static int NATIVE_STATUS_BUSY    = 2;
  public final static int NATIVE_STATUS_IDLE    = 3;
  public final static int NATIVE_STATUS_BRB     = 4;
  public final static int NATIVE_STATUS_AWAY    = 5;
  public final static int NATIVE_STATUS_PHONE   = 6;
  public final static int NATIVE_STATUS_LUNCH   = 7;
  public final static int NATIVE_STATUS_HIDDEN  = 8;
  ...
  public static void EXPECT_IS_NATIVE_STATUS(int status) throws MessagingNetworkException
  {
    ...
    MLang.EXPECT_FALSE(
      HexUtil.toHexString0x(status)+" is not valid NATIVE status.",
  ...
  private final static Hashtable m = new Hashtable(7);
  static
  {
  ...
  public static int mnemonicStringAsNativeStatus(String statusMnemonic)
  throws MExpectException
  {
    if ((statusMnemonic) == null) Lang.ASSERT_NOT_NULL(statusMnemonic, "statusMnemonic");
    Integer i = (Integer) m.get(statusMnemonic); //case sensitive
    if (i == null)
      throw new MExpectException("unknown status mnemonic: "+StringUtil.toPrintableString(statusMnemonic),
        MExpectException.CATEGORY_LOGGED_OFF_ON_BEHALF_OF_MESSAGING_SERVER_OR_PROTOCOL_ERROR,
        MExpectException.ENDUSER_LOGGED_OFF_DUE_TO_PROTOCOL_ERROR);
    return i.intValue();
  }
}