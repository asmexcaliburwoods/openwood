...
{
  fetchFromClassLocalResourceProperties(clazz, PropertyUtil.getResourceFilePathName(clazz), propertiesResourceIsRequired, systemExitOnMisconfig);
}

public static void fetchFromClassLocalResourceProperties2(Class clazz, String shortPropertiesResourceName, boolean propertiesResourceIsRequired, boolean systemExitOnMisconfig) throws RuntimeException
{
  fetchFromClassLocalResourceProperties(clazz, PropertyUtil.getResourceFilePathName(clazz, shortPropertiesResourceName), propertiesResourceIsRequired, systemExitOnMisconfig);
}

public static void fetchFromClassLocalResourceProperties(Class clazz, String fullPropertiesResourceName, boolean propertiesResourceIsRequired, boolean systemExitOnMisconfig) throws RuntimeException
{
  try
  {
    ...
    try
    {
      String resFilePathName = fullPropertiesResourceName;
