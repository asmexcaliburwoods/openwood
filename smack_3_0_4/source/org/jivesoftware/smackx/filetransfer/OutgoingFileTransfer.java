...
public class OutgoingFileTransfer extends FileTransfer {
	 ...
	 *            is complete.
	 */
	public synchronized void sendStream(final InputStream in, final String fileName,
            final long fileSize, final String description, final NegotiationProgress progress){
		checkTransferThread();
        this.callback = progress;
