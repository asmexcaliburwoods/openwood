...
public class Logger
{
  ...
  {
		if (DEBUG)
		  System.err.println(org.openmim.icq.utils.Logger.formatCurrentDate() + ": " + s);
  }  
  ...
  public static void printException(Throwable tr, java.io.PrintStream p)
  {
		...
		if (tr instanceof java.util.MissingResourceException)
		{
		  ...
		  p.println("Missing resource\nResource key:\t" + org.openmim.icq.utils.StringUtil.toPrintableString(mre.getKey()) + "\nClass: " + mre.getClassName());
		}

		//
		p.print(org.openmim.icq.utils.Logger.formatStackTrace(tr));
		p.print(org.openmim.icq.utils.Logger.formatStackTrace(new Exception("Where is this called from?")));
